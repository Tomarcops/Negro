    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card card-info">
                <div class="card-header "style="background-color: #17A2B8"><h3 class="text-center text-white">Registrar</h3></div>
...
<!--                            <label for="password-confirm" class="col-md-4 col-form-label text-md-right">{{ __('Confirm Password') }}</label>-->
                        ...
                        <div class="form-group row">
                            <div class="col-md-12 ">
                                <button type="submit" class="btn text-white   btn-block" style="background-color: #17A2B8">
                                    {{ __('Registrar') }}
                                </button>
                            </div>
                        </div>
